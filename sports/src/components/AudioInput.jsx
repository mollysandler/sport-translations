...
export default function AudioInput({ sourceLanguage, targetLanguage, onAudioSelected }) {
      ...
      <div className="input-method-content">
        {inputMethod === "upload" && (
          <div className="upload-section">
            ...
            <input id="audio-file" type="file" accept="audio/*" onChange={handleFileUpload} className="file-input" />
          </div>
        )}
        ...
        {inputMethod === "stream" && (
          <form onSubmit={handleStreamUrlSubmit} className="stream-form">
            ...
            <p className="stream-hint">Supports HLS, DASH, and direct audio streams</p>
          </form>
        )}
        ...
        {inputMethod === "record" && (
          <div className="record-section">
            {isRecording ? (
              ...
              <button onClick={handleStartRecording} className="record-button start">
                🎤 Start Recording
              </button>
            )}
            <p className="record-hint">Record live commentary directly from your microphone</p>
          </div>
        )}
      </div>
    </div>
